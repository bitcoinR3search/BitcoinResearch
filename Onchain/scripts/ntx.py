...
plt.title('Bitcoin Blockchain \n Histórico del Número Transacciones',fontsize=20,fontproperties=prop,color=tableau20[1])
plt.plot(n_block,ntx,color=tableau20[2])
...
plt.text(5000,9000,"Autor: @jpcr3spo Telegram/Twitter",fontsize=5,fontproperties=prop,color=tableau20[3])
plt.savefig('pics/blockntx.png', dpi=300)
plt.close()
