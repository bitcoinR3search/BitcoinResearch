...
plt.title(r"$\bf{BITCOIN:\ HISTORIAL\ DEL\ TAMAÑO\ DE\ BLOQUE}$" "\n" r"$\it{Comparación\ del\ size\ y\ strippedsize\ desde:\ bloque\ 1\ a\ }$" + f"{int(n_block[-1])}",fontsize=40,color=tableau20[6],fontproperties=prop)
plt.xlabel('Fecha de Confirmación del Bloque',fontsize=35,fontproperties=prop,color=tableau20[6])
plt.ylabel('Tamaño del Bloque',fontsize=35,fontproperties=prop,color=tableau20[6])
...
plt.fill_between(num_dates, strippedsize, facecolor =tableau20[2], alpha = 0.7, label='StrippedSize')
plt.fill_between(num_dates,size,strippedsize,facecolor =tableau20[0], alpha = 0.7, label='Size')
...
plt.text(datetime(2012, 12, 28),4100,'1er Halv',fontsize=18,fontproperties=prop)
plt.axvline(datetime(2016, 7, 9), color="g", label="Min")
plt.text(datetime(2016, 8, 9),4100,'2do Halv',fontsize=18,fontproperties=prop)
plt.axvline(datetime(2020, 5, 11), color="g", label="Min")
plt.text(datetime(2020, 6, 11),4100,'3er Halv',fontsize=18,fontproperties=prop)

plt.annotate('Inicio\nSegWit', xy=(datetime(2017, 1, 24),0),xytext=(datetime(2016, 1, 24),300),fontsize=15,fontproperties=prop,arrowprops=dict(facecolor='red', shrink=0.10))


# anotando el acumulado del Blockchain
plt.text(datetime(2020, 6, 1),4600,'Peso de Bloques\n'+str(round(total[-1]/10000000000,2))+' GB\nTotal: '+str(round(total_btc/10000000000,2))+' GB',fontsize=22,fontproperties=prop,color=tableau20[10])
...
plt.annotate('Presentación\nSegWit', xy=(datetime(2011, 12, 8),0),xytext=(datetime(2010, 11, 1),200),fontsize=15,fontproperties=prop,arrowprops=dict(facecolor='red', shrink=0.10))
...
plt.annotate('Primer\nOrdinal', xy=(datetime(2021, 10, 7),0),xytext=(datetime(2020, 10, 8),300),fontsize=15,fontproperties=prop,arrowprops=dict(facecolor='red', shrink=0.10))
...
plt.annotate('Lanzamiento de\nBitcoin\n9 de enero de 2009 ', xy=(datetime(2009, 2, 3),0),xytext=(datetime(2009, 2, 3),600),fontsize=15,fontproperties=prop,arrowprops=dict(facecolor='red', shrink=0.10))
...
ax2.set_yticklabels(ytick_labels, fontsize=20, fontproperties=prop, color=tableau20[6])
ax2.set_ylabel('\nTamaño acumulado',fontsize=30,fontproperties=prop,color=tableau20[6])
